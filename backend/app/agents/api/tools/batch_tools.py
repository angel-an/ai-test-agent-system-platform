...
# pragma: no cover  MC80OmFIVnBZMlhscm9ua3VMazZjbXhJVEE9PTo1OWNmMjQ2MQ==
...
# type: ignore  MS80OmFIVnBZMlhscm9ua3VMazZjbXhJVEE9PTo1OWNmMjQ2MQ==
...
async def batch_run_tests(
    ...
    async with async_session_factory() as session:
        try:
            ...
            project_result = await session.execute(project_stmt)
            project = project_result.scalar_one_or_none()
# pragma: no cover  Mi80OmFIVnBZMlhscm9ua3VMazZjbXhJVEE9PTo1OWNmMjQ2MQ==
...
# type: ignore  My80OmFIVnBZMlhscm9ua3VMazZjbXhJVEE9PTo1OWNmMjQ2MQ==
