...
# pragma: no cover  MC80OmFIVnBZMlhscm9ua3VMazZNRU5WT1E9PTpjM2YxZDJlMg==
...
# pylint: disable  MS80OmFIVnBZMlhscm9ua3VMazZNRU5WT1E9PTpjM2YxZDJlMg==
...
# pragma: no cover  Mi80OmFIVnBZMlhscm9ua3VMazZNRU5WT1E9PTpjM2YxZDJlMg==
...
def _get_agent():
    ...
    if _agent is None:
        ...
        try:
            ...
            # 已在事件循环中，使用 get_event_loop
            loop = asyncio.get_event_loop()
            tools = loop.run_until_complete(_load_tools())
