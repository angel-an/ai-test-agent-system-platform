...
# pragma: no cover  MC80OmFIVnBZMlhscm9ua3VMazZVRzVSWlE9PTo2ZTg3MDRkNA==
...
# type: ignore  MS80OmFIVnBZMlhscm9ua3VMazZVRzVSWlE9PTo2ZTg3MDRkNA==
...
# fmt: off  Mi80OmFIVnBZMlhscm9ua3VMazZVRzVSWlE9PTo2ZTg3MDRkNA==
...
async def add_test_result(
    ...
    **批量结果请求体 (使用 results 数组):**
    ...
    await db.commit()
    return SuccessResponse(success=True, data=result)
# fmt: off  My80OmFIVnBZMlhscm9ua3VMazZVRzVSWlE9PTo2ZTg3MDRkNA==
