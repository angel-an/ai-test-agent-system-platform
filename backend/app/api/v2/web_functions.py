...
# noqa  MC80OmFIVnBZMlhscm9ua3VMazZjbXB0Y3c9PToyNzM4ZTMwYw==
...
# ============ 路由定义 ============
# pragma: no cover  MS80OmFIVnBZMlhscm9ua3VMazZjbXB0Y3c9PToyNzM4ZTMwYw==
...
async def create_web_function(
    ...
    logger.info(f"[create_web_function] 收到请求: project={project_identifier}, display_name={request.display_name}, name={request.name}, folder_id={request.folder_id}")
    ...
    try:
        ...
        logger.info(f"[create_web_function] 创建成功: {result}")
        return SuccessResponse(data=result, message="Web 功能创建成功")
    except Exception as e:
        logger.error(f"[create_web_function] 创建失败: {e}", exc_info=True)
        raise
...
# pylint: disable  Mi80OmFIVnBZMlhscm9ua3VMazZjbXB0Y3c9PToyNzM4ZTMwYw==
...
# type: ignore  My80OmFIVnBZMlhscm9ua3VMazZjbXB0Y3c9PToyNzM4ZTMwYw==
