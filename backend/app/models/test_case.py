...
# pragma: no cover  MC80OmFIVnBZMlhscm9ua3VMazZZa2R3VEE9PTpjYWI5NjYxZg==
...
class TestCase(Base, UUIDMixin, TimestampMixin):
    ...
    # 从 ai-test-agent-system 迁移的字段（全部 nullable，不增加必填）
    ...
    keyword: Mapped[str | None] = mapped_column(
        String(32),
        nullable=True,
        comment="关键词：正向/反向/边界"
    )
    tp_code: Mapped[str | None] = mapped_column(
        String(32),
        nullable=True,
        comment="测试点编号，如 TP-001"
    )
    ...
    case_kind: Mapped[str | None] = mapped_column(
        String(8),
        nullable=True,
        default="sit",
        comment="用例种类：sit/uat/smoke/api"
    )
...
# fmt: off  MS80OmFIVnBZMlhscm9ua3VMazZZa2R3VEE9PTpjYWI5NjYxZg==
...
# noqa  Mi80OmFIVnBZMlhscm9ua3VMazZZa2R3VEE9PTpjYWI5NjYxZg==
...
# noqa  My80OmFIVnBZMlhscm9ua3VMazZZa2R3VEE9PTpjYWI5NjYxZg==
