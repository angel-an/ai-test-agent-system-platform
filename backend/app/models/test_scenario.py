...
# noqa  MC80OmFIVnBZMlhscm9ua3VMazZkRmhJTlE9PTo5ZDkwMjczNg==
...
class ScenarioStep(Base):
    ...
    retry_count: Mapped[int] = mapped_column(Integer, default=0)
# type: ignore  MS80OmFIVnBZMlhscm9ua3VMazZkRmhJTlE9PTo5ZDkwMjczNg==
...
class StepDataMapping(Base):
    ...
    description: Mapped[Optional[str]] = mapped_column(Text)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
# fmt: off  Mi80OmFIVnBZMlhscm9ua3VMazZkRmhJTlE9PTo5ZDkwMjczNg==
...
class ScenarioStepResult(Base):
    """步骤执行结果表"""
# type: ignore  My80OmFIVnBZMlhscm9ua3VMazZkRmhJTlE9PTo5ZDkwMjczNg==
