...
# type: ignore  MC80OmFIVnBZMlhscm9ua3VMazZTMHR3YWc9PToxN2M2MTU2Mw==
...
# type: ignore  MS80OmFIVnBZMlhscm9ua3VMazZTMHR3YWc9PToxN2M2MTU2Mw==
...
# fmt: off  Mi80OmFIVnBZMlhscm9ua3VMazZTMHR3YWc9PToxN2M2MTU2Mw==
    ...
    # rev56（断言编译）：expected_results 保存时编译的结构化断言 + 判定模式
    # （compiled=全部可机检 / human_oracle=全部人工 / mixed=混合）
    compiled_assertions: Mapped[list | None] = mapped_column(
        JSONB,
        nullable=True,
        default=list,
        comment="expected_results 编译产物（结构化可机检断言，rev56）",
    )
    assertion_mode: Mapped[str | None] = mapped_column(
        String(20),
        nullable=True,
        comment="断言模式：compiled / human_oracle / mixed（rev56）",
    )
...
# pragma: no cover  My80OmFIVnBZMlhscm9ua3VMazZTMHR3YWc9PToxN2M2MTU2Mw==
