...
# noqa  MC80OmFIVnBZMlhscm9ua3VMazZWVXd4TXc9PTo3NmE4ZGQ4OA==
...
# fmt: off  MS80OmFIVnBZMlhscm9ua3VMazZWVXd4TXc9PTo3NmE4ZGQ4OA==
    ...
    async def count_by_project(self, project_id: UUID, folder_type: Optional[str] = None) -> int:
        ...
        return result.scalar_one()
# fmt: off  Mi80OmFIVnBZMlhscm9ua3VMazZWVXd4TXc9PTo3NmE4ZGQ4OA==
        ...
        for tc in test_cases:
            ...
            for _ in range(max_retries):
                ...
                if check_result.scalar_one() == 0:
                    break
# noqa  My80OmFIVnBZMlhscm9ua3VMazZWVXd4TXc9PTo3NmE4ZGQ4OA==
