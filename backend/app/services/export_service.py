...
# noqa  MC80OmFIVnBZMlhscm9ua3VMazZNRlJDUlE9PToyZDJkOTNmNQ==
...
class ExportService:
    ...
    def __init__(self, db: AsyncSession, mongodb: Optional[AsyncIOMotorDatabase] = None):
        self.db = db
    ...
    async def start_bdd_export(
        ...
        """
        if not self.mongodb:
            raise BadRequestException("MongoDB 未连接，导出功能暂时不可用")
...
# fmt: off  MS80OmFIVnBZMlhscm9ua3VMazZNRlJDUlE9PToyZDJkOTNmNQ==
    ...
    async def _generate_feature_content(self, job: dict) -> str:
        ...
        # 这里生成示例内容
        lines = []
# pragma: no cover  Mi80OmFIVnBZMlhscm9ua3VMazZNRlJDUlE9PToyZDJkOTNmNQ==
...
# pragma: no cover  My80OmFIVnBZMlhscm9ua3VMazZNRlJDUlE9PToyZDJkOTNmNQ==
