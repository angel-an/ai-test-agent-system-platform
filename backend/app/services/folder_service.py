...
# pragma: no cover  MC80OmFIVnBZMlhscm9ua3VMazZUbnBhYVE9PToxOGE5NWU5Nw==
...
class FolderService:
    ...
    async def _folder_to_info(self, folder: Folder, project_identifier: str) -> FolderInfo:
        ...
        if folder.folder_type == FolderType.WEB_TEST:
            ...
            for func in functions:
                total_sub_functions += (func.total_sub_functions or 0)
        ...
        if folder.folder_type == FolderType.API_TEST:
            total_endpoints_count = await self.repo._get_total_endpoints_count(folder.id)
    ...
    async def get_root_folders(
        ...
        for folder in folders:
            info = await self._folder_to_info(folder, project_identifier)
            result.append(info)
# pragma: no cover  MS80OmFIVnBZMlhscm9ua3VMazZUbnBhYVE9PToxOGE5NWU5Nw==
...
# pragma: no cover  Mi80OmFIVnBZMlhscm9ua3VMazZUbnBhYVE9PToxOGE5NWU5Nw==
    ...
    async def update_folder(
        ...
        return await self._folder_to_info(folder, project_identifier)
# pragma: no cover  My80OmFIVnBZMlhscm9ua3VMazZUbnBhYVE9PToxOGE5NWU5Nw==
