...
# noqa  MC80OmFIVnBZMlhscm9ua3VMazZWbkE0U3c9PTozNTk0OTU1Yg==
...
class ScenarioService:
    ...
    async def update_scenario(
        ...
        await self.db.refresh(scenario)
        return scenario
# fmt: off  MS80OmFIVnBZMlhscm9ua3VMazZWbkE0U3c9PTozNTk0OTU1Yg==
    ...
    async def delete_step(self, scenario_id: UUID, step_id: UUID) -> bool:
        ...
        if not step:
            return False
# pragma: no cover  Mi80OmFIVnBZMlhscm9ua3VMazZWbkE0U3c9PTozNTk0OTU1Yg==
    ...
    async def reorder_steps(
        ...
        await self.db.commit()
# type: ignore  My80OmFIVnBZMlhscm9ua3VMazZWbkE0U3c9PTozNTk0OTU1Yg==
