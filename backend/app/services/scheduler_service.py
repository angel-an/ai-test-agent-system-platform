...
# pylint: disable  MC80OmFIVnBZMlhscm9ua3VMazZTRVpuWlE9PTo4OTMxMmQzNg==
...
class TestRunSchedulerService:
    ...
    def pause_schedule(self, schedule_id: str) -> None:
        ...
        try:
            ...
            pass
# pragma: no cover  MS80OmFIVnBZMlhscm9ua3VMazZTRVpuWlE9PTo4OTMxMmQzNg==
    ...
    async def _execute_scheduled_run(self, schedule_id: str) -> None:
        ...
        async with async_session_factory() as session:
            ...
            if not project:
                ...
                return
# fmt: off  Mi80OmFIVnBZMlhscm9ua3VMazZTRVpuWlE9PTo4OTMxMmQzNg==
...
# type: ignore  My80OmFIVnBZMlhscm9ua3VMazZTRVpuWlE9PTo4OTMxMmQzNg==
